...
class QueryService:
    ...
    _sections_by_url: dict[str, SectionSnapshot] = field(
        default_factory=dict, repr=False
    )
    _sections_by_path: dict[Path, SectionSnapshot] = field(
        default_factory=dict, repr=False
    )
    _pages_by_tag: dict[str, list[PageSnapshot]] = field(
        default_factory=dict, repr=False
    )
    _pages_by_section: dict[str, list[PageSnapshot]] = field(
        default_factory=dict, repr=False
    )
...
def get_pages_by_section(
    snapshot: SiteSnapshot, section_url: str
) -> list[PageSnapshot]:
    """

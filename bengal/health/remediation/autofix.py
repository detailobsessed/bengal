    ...
    def _create_file_fix(self, file_path: Path, line_numbers: list[int]) -> Any:
        ...
        def apply_fix() -> bool:
            ...
            try:
                ...
                directives_list = [
                    d for d in directives if d["line"] in directives_to_fix
                ]
    ...
    def _create_fence_fix(self, file_path: Path, line_number: int) -> Any:
        ...
        def apply_fix() -> bool:
            ...
            try:
                ...
                if (
                    target_directive["current_depth"]
                    < target_directive["required_depth"]
                ):

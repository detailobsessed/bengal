...
class SpeculationRulesGenerator:
    ...
    def _get_speculation_config(self) -> dict[str, Any]:
        ...
        doc_app_raw = self.site.config.get("document_application", {})
        doc_app = doc_app_raw if isinstance(doc_app_raw, dict) else {}
        speculation_raw = doc_app.get("speculation", {})
        return speculation_raw if isinstance(speculation_raw, dict) else {}

...
class TestContentMigratorLinkDetection:
    ...
    def mock_site_with_pages(self) -> MagicMock:
        ...
        mock_page.content = (
            "<p>Check <a href='/docs/guide'>this link</a> for more info.</p>"
        )
    ...
    def test_finds_links_in_markdown_source(
        self, mock_site_with_pages: MagicMock
    ) -> None:
    ...
    def test_link_detection_ignores_html_anchors(self) -> None:
        ...
        mock_page.content = (
            "<p>Check <a href='/docs/guide'>this</a></p>"  # Has HTML link
        )
...
class TestContentMigratorLargePageDetection:
    ...
    def test_counts_lines_from_markdown_not_html(self) -> None:
        ...
        assert len(large_findings) == 1, (
            "Should detect page with 600 markdown lines as large"
        )
    ...
    def test_small_markdown_not_detected_as_large(self) -> None:
        ...
        assert len(large_findings) == 0, (
            "Page with 100 lines should not be flagged as large"
        )
...
class TestContentMigratorOrphanDetection:
    ...
    def test_orphan_detection_uses_markdown_source(self) -> None:
        ...
        if orphan_findings:
            ...
            assert len(page_b_paths) == 0, (
                "page-b has incoming link, should not be orphan"
            )
...
"""
        ...
        mock_page.content = (
            "<h1>Title</h1><p>Some intro text.</p>..."  # Different structure
        )

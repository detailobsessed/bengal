...
class TestTemplateValidatorEngineAgnostic:
    ...
    def test_validator_handles_multiple_errors(self):
        ...
        mock_engine.validate.return_value = [
            TemplateError(
                template="a.html", message="Error A", line=1, error_type="syntax"
            ),
            TemplateError(
                template="b.html", message="Error B", line=2, error_type="undefined"
            ),
            TemplateError(
                template="c.html", message="Error C", line=None, error_type="other"
            ),
        ]
